...
# dataset = 'aae2-oracle/adus'
dataset = 'argmicro-oracle/adus'

# model_name = 'unsloth/llama-3-8b-Instruct'
model_name = 'unsloth/Meta-Llama-3.1-8B-Instruct'
config_name = 'lora-r16-qkvgud-bs8-ac1-e02-fp' #r = rank of lora g=gate-proj u=up-proj d=down-proj fp = full presicion
